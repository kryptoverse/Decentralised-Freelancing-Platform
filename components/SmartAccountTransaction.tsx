        ...
        <>
          ...
          {!hasError && !isSuccess && !isLoading && (
            <>
              ...
              {hasBalance && smartAccount && (
                <>
                  ...
                  <p className="smart-account-info">
                    ✨ <strong>Smart Account Benefits:</strong> No gas fees, better UX, and enhanced security
                  </p>
                  <Button className="tx-button" onClick={handleSendUserOperation} disabled={isLoading}>
              ...
              {!hasBalance && (
                <>
                  <p>This example transaction sends a tiny amount of ETH from your wallet to itself.</p>
                  <p className="smart-account-info">
                    ℹ️ <strong>Note:</strong> Even though this is a gasless transaction, you still need ETH in your
                    account to send it. Get some from{" "}
