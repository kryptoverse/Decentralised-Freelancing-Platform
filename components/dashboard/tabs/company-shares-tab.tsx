    ...
    <div className="space-y-8">
      ...
      {userRole === "founder" && (
        <motion.button
          ...
          className="rounded-full px-6 py-3 font-medium transition-all duration-300 ease-out hover:scale-105 active:scale-95 gradient-primary text-white shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40"
        >
          Launch Your Company
