    ...
    <div className="h-full flex flex-col gap-6">
      ...
      {userRole === "client" && (
        <motion.button
          ...
          className="rounded-full px-6 py-3 font-medium transition-all duration-300 ease-out hover:scale-105 active:scale-95 bg-gradient-primary text-primary-foreground shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 w-fit"
        >
          Post a New Job
