    ...
    >
      ...
      <div>
        ...
        <input
          ...
          className={`w-full px-3 py-2 rounded-lg border bg-background focus:outline-none ${errors.name ? "border-red-500" : "border-border"
            }`}
        />
      ...
      <div>
        ...
        <input
          ...
          className={`w-full px-3 py-2 rounded-lg border bg-background focus:outline-none focus:ring-2 focus:ring-primary ${errors.headline ? "border-red-500" : "border-border"
            }`}
        />
      ...
      <div>
        ...
        <textarea
          ...
          className={`w-full px-3 py-2 rounded-lg border bg-background focus:outline-none focus:ring-2 focus:ring-primary resize-none ${errors.bio ? "border-red-500" : "border-border"
            }`}
        />
      ...
      <div>
        ...
        <input
          ...
          className={`w-full px-3 py-2 rounded-lg border bg-background focus:outline-none ${errors.skills ? "border-red-500" : "border-border"
            }`}
        />
      ...
      <div>
        ...
        {errors.education && <p className="text-sm text-red-500 mb-2">{errors.education}</p>}
      ...
      <div>
        ...
        {errors.experience && <p className="text-sm text-red-500 mb-2">{errors.experience}</p>}
      ...
      <div>
        ...
        {errors.portfolio && <p className="text-sm text-red-500 mb-2">{errors.portfolio}</p>}
